Ext.define('MyApp.view.main.KitchenSink.FormField_5_field_replicator_view', {
    // SUMMARY:  CHƯA CHẠY - LỖI: PLUGIN = "fieldreplicator"

    extend: 'Ext.panel.Panel',
    xtype: 'FormField_5_field_replicator_view',
    ...
    items: [{
        ...
        items: [{
            ...
            displayField: 'email',
            // fieldreplicator = LẶP ĐI LẶP LẠI - VIỆC THÊM COMBOBOX - khi combobox được gán giá trị
            plugins: 'fieldreplicator', //  cydb - ??? - LỖI
            fieldLabel: 'Send To',
            anchor: '0',
            queryMode: 'local',
            selectOnTab: false,
            ...
            onReplicate: function () {
                this.getStore().clearFilter();      // cydb
            }
        }]
    }, 
    {
