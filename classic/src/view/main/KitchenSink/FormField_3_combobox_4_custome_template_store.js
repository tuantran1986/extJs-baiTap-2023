Ext.define('MyApp.view.main.KitchenSink.FormField_3_combobox_4_custome_template_store', {
    // SUMMARY: 

    extend: 'Ext.data.Store',
    alias: 'store.FormField_3_combobox_4_custome_template_store',
    storeId: 'FormField_3_combobox_4_custome_template_store_Id',
